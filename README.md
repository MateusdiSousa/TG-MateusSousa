...
Meu nome é Mateus de Sousa, tenho 20 anos e iniciei meus estudos de Análise e Desenvolvimento de Sistemas no segundo semestre de 2022. Na faculdade, obtive experiências importantes para o meu conhecimento na área da tecnologia, como participar da maratona de programação da FATEC e realizar o curso de verão sobre os fundamentos da AWS, que me fez entender os serviços de nuvem que eles ofereciam e conquistar um certificado da AWS.

Durante o semestre, aprendi algumas linguagens de programação, como Python e Java, e a metodologia ágil Scrum. Pude consolidar todos esses conhecimentos na prática com o método de Aprendizagem por Projetos Integrados (API), e, graças a essa experiência, no 3º semestre consegui iniciar minha carreira na área como estagiário na empresa IONIC Health, onde contribuo na área de qualidade de software.
...
#### Soft Skills
<ul>
    <li><b>Gestão de tempo:</b> Priorizei meu tempo de acordo com a relevância da tarefa e o prazo estabelicido, visando entregar todas a funcionalidades essenciais estabelicidas na sprint em pleno funcionamento, por exemplo: tinha duas tarefas para entregar na primeira sprint sendo elas criar a página de formulário para abrir um chamado e inserção de todos os dados dos computadores da FATEC no banco de dados. nessa situação eu priorizei o banco de dados pois seria uma tarefa que demadaria tempo, e seria essencial para que outras atividades pudessem ser realizadas como a abertura de chamados e a navegação pelas salas da FATEC</li>
    <li><b>Comunicação:</b> Durante o projeto comunicava ao meu time meu progresso na realização de minhas tarefas mantendo todos sempre informados sobre o que estava fazendo,, por exemplo sempre que eu terminava uma tarefa além de commitar para o repositório eu avisava para meu grupo durante as aulas e pedia um feedback para o meu companheiro de equipe mais experiência para ter certeza de que tudo estava como o esperado.</li>
    <li><b>Trabalho em equipe:</b> Sempre que encontrava alguma dificuldade na realização de uma tarefa, conseguia pedir ajuda a um de meus companheiros, além de ajudar aqueles que precisavam de auxílio, por exemplo: Na 2ª sprint eu teria que realizar a funcionalidade de atualização dos dados de uma máquina, como era iniciante na época tive um pouco de dificuldade de como seria para trazer os dados de uma máquina do banco de dados para o formulário de atualização, então ele me deu a dica de passar o id da máquina na URL para então realizar uma requisição com o flask para pegar os dados da máquina no banco de dados usando o id da URL e depois preencher os dados.</li>
</ul>
